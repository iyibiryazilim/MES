...
var WorkStationGroupList = function () {
    ...
    var initDatatable = function () {
        ...
        var postUrl = '/WorkStationGroup/GetJsonResult';
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var output;
                        output = `<div class="badge badge-light-success">Automated</div>`
                        return output;
