...
var ProductionOrderList = (function () {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            output =
              ` <a href="#" class="badge badge-light-success fs-7 fw-bold my-2">` +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var output;
            output = `<div class="fw-bold">` + full.unitset + `</div>`;
            return output;
          },
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if (full.realizationRate <= 33 && full.realizationRate >= 0) {
              output =
                ...
                "%" +
                full.realizationRate +
                `</div>
                                    <div class="h-8px mx-3 w-100 bg-light-danger rounded">
									<div class="bg-danger rounded h-8px" role="progressbar" style="width: ` +
                progressBarWidth +
                `%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
								  </div>`;
              return output;
            } else if (
              full.realizationRate > 33 &&
              full.realizationRate <= 66
            ) {
              output =
                `<div class="text-muted fs-7 fw-bold">` +
                "%" +
                ...
                `</div>
									...
									<div class="bg-warning rounded h-8px" role="progressbar" style="width: ` +
                progressBarWidth +
                `%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
								  </div>`;
              return output;
  ...
  var handleSearchDatatable = () => {
    const filterSearch = document.querySelector(
      '[mes-production-order-table-filter="search"]'
    );
