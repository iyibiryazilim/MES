...
// Class definition
var RawProductSalesOrderLineList = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initDatatable = function () {
        ...
        var postUrl = '../../RawProduct/GetSalesOrderLineJsonResult?productReferenceId=' + id;
    ...
    return {
        init: function () {
            table = document.querySelector('#mes_rawproduct_sales_order_line_table');
...
KTUtil.onDOMContentLoaded(function () {
    RawProductSalesOrderLineList.init();
});