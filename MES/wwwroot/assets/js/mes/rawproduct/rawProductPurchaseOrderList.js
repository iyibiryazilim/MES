...
// Class definition
var RawProductPurchaseOrderLineList = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initDatatable = function () {
        var id = $('#RawProductId').val();
        var postUrl = '../../RawProduct/GetPurchaseOrderLineJsonResult?productReferenceId=' + id;
    ...
    return {
        init: function () {
            table = document.querySelector('#mes_rawproduct_purchase_order_line_table');
...
KTUtil.onDOMContentLoaded(function () {
    RawProductPurchaseOrderLineList.init();
});