...
// Class definition
var SemiProductPurchaseOrderLineList = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initDatatable = function () {
        var id = $('#SemiProductId').val();
        var postUrl = '../../SemiProduct/GetPurchaseOrderLineJsonResult?productReferenceId=' + id;
        ...
        datatable = $(table).DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var output;
                        output = `<a href="SalesOrder/Detail/?FicheReferenceId=` + full.referenceId + `" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" >` + full.code + `</a>`
                ...
                },
                {
                    ...
                    className: 'text-start pe-0',
                    render: function (data, type, full, meta) {
                        //                var value = full.current.definition;
                        //var firstLetter = value.charAt(0).toUpperCase();
                        var output;
                        output = `<div class="d-flex">
							<!--begin:: Avatar -->
																<div class="symbol symbol-50px symbol-circle">
                            <span class="symbol-label bg-dark-grey text-dark fs-12 fw-bolder">` + + `</span>
																</div>
																<!--end::Avatar-->
							<div class="ms-5">
								<!--begin::Title-->
								<a href="../../demo46/dist/apps/ecommerce/catalog/edit-category.html" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">`+ + `</a>
								<!--end::Title-->
								<!--begin::Description-->
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var output;
                        output = `<span class="fw-bold">` + full.netTotal + `</span>`
    ...
    return {
        init: function () {
            table = document.querySelector('#mes_semiproduct_purchase_order_line_table');
...
KTUtil.onDOMContentLoaded(function () {
    SemiProductPurchaseOrderLineList.init();
});