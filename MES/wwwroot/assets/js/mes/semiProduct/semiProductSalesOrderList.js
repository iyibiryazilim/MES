...
// Class definition
var SemiProductSalesOrderLineList = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initDatatable = function () {
        ...
        var postUrl = '../../SemiProduct/GetSalesOrderLineJsonResult?productReferenceId=' + id;
    ...
    return {
        init: function () {
            table = document.querySelector('#mes_semiproduct_sales_order_line_table');
...
KTUtil.onDOMContentLoaded(function () {
    SemiProductSalesOrderLineList.init();
});