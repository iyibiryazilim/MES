...
var MESMonthlyOutput = function () {
    ...
    var e = {
        ...
        $.post('../../EndProduct/GetMonthlyOutputJsonResult?productReferenceId=' + referenceId, function (result) {
            ...
            console.log("output Son Elemanın Anahtarları:", keys);
            console.log("output Son Elemanın Değerleri:", values);
