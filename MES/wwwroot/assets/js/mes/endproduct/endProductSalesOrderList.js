...
// Class definition
var EndProductSalesOrderLineList = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initDatatable = function () {
        var id = $('#EndProductId').val();
        var postUrl = '../../EndProduct/GetSalesOrderLineJsonResult?productReferenceId=' + id;
    ...
    return {
        init: function () {
            table = document.querySelector('#mes_endproduct_sales_order_line_table');
...
KTUtil.onDOMContentLoaded(function () {
    EndProductSalesOrderLineList.init();
});