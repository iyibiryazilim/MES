...
var MESMonthlyInput = function () {
    ...
    var e = {
        ...
        $.post('../../EndProduct/GetMonthlyInputJsonResult?productReferenceId=' + referenceId, function (result) {


            var lastItem = result.data[result.data.length - 1];
            var monthlyInputKeys = lastItem.monthlyInputValues;
            var keys = Object.keys(monthlyInputKeys); //GRAPH KEYS
            var monthlyInputValues = lastItem.monthlyInputValues;
            var values = Object.values(monthlyInputValues); //GRAPH VALUES
