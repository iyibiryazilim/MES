...
namespace MES.Administration.Views.Controls;
...
public partial class TabBarView : ContentView
{
    ...
    public TabBarView()
    {
        App.Current.Resources.TryGetValue("Black", out object primaryColor);
        App.Current.Resources.TryGetValue("Primary", out object secondaryColor);
